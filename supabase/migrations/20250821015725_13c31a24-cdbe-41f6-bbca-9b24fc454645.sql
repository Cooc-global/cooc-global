...
-- Create or update the daily returns calculation function to ensure proper integration
...
SELECT cron.schedule(
  ...
  $$
  SELECT public.calculate_daily_returns();
  $$
);

-- Create a manual trigger function for developers to process returns immediately
