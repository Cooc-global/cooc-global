...
-- Create partial unique index for active currency rates
CREATE UNIQUE INDEX currency_rates_active_unique 
ON public.currency_rates (from_currency, to_currency) 
WHERE active = true;
