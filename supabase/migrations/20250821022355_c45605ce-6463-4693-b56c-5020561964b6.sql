-- Update sample marketplace data with Kenyan names and proper Safaricom numbers
...
-- Insert updated sample data with Kenyan names and Safaricom numbers (last 3 digits concealed)
